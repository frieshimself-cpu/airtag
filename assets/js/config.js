...
AIRTAG.CONFIG = {
  ...
  /* The $VEDANT token (Solana / pump.fun).
   *
   ...
   *
   * TO RE-ARM: set `ca` to the Solana mint below. The token module,
   * mission-bar chip, pump/dex/solscan links, and DexScreener
   * telemetry all resume automatically — every URL is derived from
   * `ca` at runtime, so this is the only edit needed. */
  TOKEN: {
    symbol: "VEDANT",
    ca: "",
    chain: "solana",
